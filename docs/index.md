...
hero:
  name: "Vite Asset Pack"
  text: "Enterprise-grade asset optimization."
  tagline: Lightning fast SVG minification, raster image compression, WebP conversion, and beautiful terminal reporting for Vite.
  actions:
    - theme: brand
      text: Get Started
    ...
    - theme: alt
      text: View on GitHub
      link: https://github.com/saitejabandaru-in/vite-plugin-asset-pack
