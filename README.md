...
- **📸 Next-Gen Raster Compression:** Powered by `sharp` to automatically compress JPEGs, PNGs, and auto-convert to WebP or AVIF (the absolute bleeding edge of image formats).
...
export default defineConfig({
  plugins: [
    assetPackPlugin({
      ...
      convertToAvif: true, // Or use AVIF for 50% better compression than WebP!
